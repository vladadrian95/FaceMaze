...
class Tw_User extends CI_Model {
	...
	*/
   	...
   	* Param is an array that contains the twitter id and name
   	...
   	*/
   	public function insert_twitter_user($data) {
   		...
   		$sql = "BEGIN tw_users_pack.insert_tw_user(:bind1, :bind2, :bind3); END;";
    ...
    * Param is an array that contains the twitter id
    ...
    */
    public function delete_user($data) {
        ...
        $sql = "BEGIN tw_users_pack.delete_user(:bind1, :bind2); END;";
        $query = oci_parse($conn, $sql);
        oci_bind_by_name($query, ":bind1", $data['id']);
    ...
    */
    public function get_high_score($data) {
        ...
        $sql = "BEGIN :result := tw_users_pack.get_high_score(:bind1); END;";
        $query = oci_parse($conn, $sql);
        oci_bind_by_name($query, ":bind1", $data['id']);
    ...
    */
    public function get_last_score($data) {
      ...
      $sql = "BEGIN :result := tw_users_pack.get_last_score(:bind1); END;";
      $query = oci_parse($conn, $sql);
      oci_bind_by_name($query, ":bind1", $data['id']);
      oci_bind_by_name($query, ":result", $message, 32);
      oci_execute($query);
    ...
    * Param is an array that contains the twitter id and the new score
    * Returns a status message
    */
